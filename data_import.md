...
can load janitor package in the setup but we only use one function, we
...
<dbl> perticular kind of number numerical variable
...
view(litters\_df) open another window better use in the console
